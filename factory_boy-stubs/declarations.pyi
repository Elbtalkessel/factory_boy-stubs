...
class Transformer(BaseDeclaration):
    ...
    UNROLL_CONTEXT_BEFORE_EVALUATION: bool
    class Force:
        forced_value: Incomplete
        def __init__(self, forced_value) -> None: ...
    default: Incomplete
...
class Iterator(BaseDeclaration):
    ...
    def __init__(self, iterator, cycle: bool = True, getter: Incomplete | None = None) -> None: ...
    def evaluate(self, instance, step, extra): ...
    def reset(self) -> None: ...
...
class ContainerAttribute(BaseDeclaration):
    function: Incomplete
    strict: Incomplete
    def __init__(self, function, strict: bool = True) -> None: ...
    def evaluate(self, instance, step, extra): ...
...
class Dict(SubFactory):
    FORCE_SEQUENCE: bool
    def __init__(self, params, dict_factory: str = 'factory.DictFactory') -> None: ...

class List(SubFactory):
    FORCE_SEQUENCE: bool
    def __init__(self, params, list_factory: str = 'factory.ListFactory') -> None: ...
...
class RelatedFactoryList(RelatedFactory):
    size: Incomplete
    def __init__(self, factory, factory_related_name: str = '', size: int = 2, **defaults) -> None: ...
    def call(self, instance, step, context): ...
