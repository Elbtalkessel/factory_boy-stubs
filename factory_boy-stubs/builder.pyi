...
class DeclarationSet:
    ...
    contexts: Incomplete
    def __init__(self, initial: Incomplete | None = None) -> None: ...
    @classmethod
    def split(cls, entry): ...
    @classmethod
...
def parse_declarations(decls, base_pre: Incomplete | None = None, base_post: Incomplete | None = None): ...
...
class BuildStep:
    ...
    stub: Incomplete
    def __init__(self, builder, sequence, parent_step: Incomplete | None = None) -> None: ...
    def resolve(self, declarations) -> None: ...
    @property
    def chain(self): ...
    def recurse(self, factory, declarations, force_sequence: Incomplete | None = None): ...
...
class StepBuilder:
    ...
    def build(self, parent_step: Incomplete | None = None, force_sequence: Incomplete | None = None): ...
